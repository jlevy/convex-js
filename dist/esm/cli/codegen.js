...
export const codegen = new Command("codegen").summary("Generate backend type definitions").description(
  ...
  "--offline",
  "Generate types locally without connecting to a backend. Uses TypeScript type inference from local files. Provides full type safety for your functions and data. Components (if you use them) become 'any'. Ideal for CI/CD pipelines and offline development."
