...
import { ArgsAndOptions, UserIdentityAttributes } from "../server/index.js";
...
export declare class ConvexHttpClient {
     ...
     * @internal
     */
    setAdminAuth(token: string, actingAsIdentity?: UserIdentityAttributes): void;
    /**
     ...
     * @internal
     */
    function<AnyFunction extends FunctionReference<"query" | "mutation" | "action">>(anyFunction: AnyFunction | string, componentPath?: string, ...args: OptionalRestArgs<AnyFunction>): Promise<FunctionReturnType<AnyFunction>>;
}
/**
 * @internal
 */
